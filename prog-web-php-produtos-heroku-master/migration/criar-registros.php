...
if ($db->connect()) {
  ...
  $clientes[] = new Cliente("Thiago", "Souza", "teste1@hotmail.com","(66) 11111 1111", "10/01/1998", "78100-000","Rua das alameda", "Centro", "Rondonópolis", "MT");
  $clientes[] = new Cliente("Joao", "Fulano", "teste2@hotmail.com","(66) 22222 2222", "20/02/1998", "78200-000","Rua sem saida", "Centro", "Rondonópolis", "MT");
  $clientes[] = new Cliente("Maria", "Fulano", "teste3@hotmail.com","(66) 33333 3333", "30/03/1998", "78300-000","Rua dos alfeneiros", "Centro", "Rondonópolis", "MT");
